...
{
	const std::vector<float> epList[] = { { 0.6425f, 0.945f, 0.6775f, 0.462f, 0.6115f, 0.455f, 0.6225f, 0.075f, 0.3225f, 0.055f, 0.315f, 0.425f, 0.5175f, 0.415f },
	...
	int choice = Random::rand() % sizeof(epList);
